...
namespace DC
{
	...
	public:
		...
		bool isSubscribedToService(const String& strServiceName);
		...
		void postNewMessage(CMessage& newMessage, const String& strServiceName);
	...
	private:
		String _mstrName;			// Name of this message user.

		// List of names this user is subscribed to
		std::list<String> _mlstSubscribedServiceNames;
