...
namespace DC
{
	...
	public:
		...
		CQuadTreeNode(const Rect& rectRegion, CQuadTreeNode* pParentNode, CQuadTree* pQuadTree);
...
//		void debugRenderEntities(CResourceVertexBufferLine* pLine, int iCircleRadius, unsigned int uiCircleNumSegments) const;
		...
		void getNodesWithEntitiesWhichIntersect(std::vector<CQuadTreeNode*>& vecNodes, const Rect& rect);
