...
namespace DC
{
	...
	public:
		...
		// Example:
		// Vector4f vOne(1.0f, 1.0f, 1.0f, 1.0f);
		// Vector4f vTwo(2.0f, 2.0f, 2.0f, 2.0f);
		// Vector4f vThree = vOne + vTwo;
		...
		// Example:
		// Vector4f vOne(1.0f, 1.0f, 1.0f, 1.0f);
		// Vector4f vThree(2.0f, 2.0f, 2.0f, 2.0f);
		// vThree += vOne;
		...
		// Vector4f vOne(1.0f, 1.0f, 1.0f, 1.0f);
		// Vector4f vTwo(2.0f, 2.0f, 2.0f, 2.0f);
		// Vector4f vMinusOne = vOne - vTwo;
		Vector4f operator -(const Vector4f& vec) const;

		// Subtraction operator 
		// Vector subtraction is not commutative. (v1 - v2 == v2 - v1) is only true when v1 is same as v2.
		// Example:
		// Vector4f vMinusOne(1.0f, 1.0f, 1.0f, 1.0f);
		// Vector4f vTwo(2.0f, 2.0f, 2.0f, 2.0f);
		// vMinusOne -= vTwo;
		Vector4f& operator -=(const Vector4f& vec);
		...
		// Example:
		// Vector4f vTwo(2.0f, 2.0f, 2.0f, 2.0f);
		// Vector4f vOne = vTwo * 0.5f;
		const Vector4f operator *(const float f) const;

		// Multiplication by scalar
		// Adjusts the magnitude of a vector, keeping the direction the same (Unless the scalar is negative, in which case the direction is reversed) 
		// Example:
		// Vector4f vOne(2.0f, 2.0f, 2.0f, 2.0f);
		// vOne *= 0.5f; 
		void operator *=(const float f);

		// Multiplication by another vector
		// Example:
		// Vector4f vOne(3.0f, 3.0f, 3.0f, 3.0f);
		// Vector4f vTwo(2.0f, 2.0f, 2.0f, 2.0f);
		// Vector4f vResult = vOne * vTwo;
