...
//			}
		...
		// std::vector<std::wstring> imageFilenames;			// Holds each individual image's filename 
		// std::vector<Image2D*> images;						// Holds each individual image's image data
	...
	Image2D* ImageAtlasPacker::getAtlasImage(unsigned int index) const
	{
