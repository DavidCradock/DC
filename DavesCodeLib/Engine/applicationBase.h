...
namespace DC
{
	...
	// A base class to derive a new class from to use with the Engine class.
	...
	// to the Engine class via it's go() method.
	class ApplicationBase
	{
	public:
		// Pure virtual. Needs to be overridden.
		// Gets called at the beginning of the application's main loop.
		virtual void onUpdate(double timeInSecondsSinceLastCall, Engine* pFramework) = 0;
