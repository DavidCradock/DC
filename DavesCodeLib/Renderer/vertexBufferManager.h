...
namespace DC
{
	// Manager class to handle vertex buffer objects.
	...
	public:
		...
		VertexBuffer* add(const String& objectName);
		...
		VertexBuffer* get(const String& objectName);
		...
		VertexBuffer* remove(const String& objectName);
